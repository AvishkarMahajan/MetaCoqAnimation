...
Print TemplateMonad.
MetaRocq Run (t <- tmQuote rel4ConsFAnimated ;; tmPrint t).
            ...
            (tCase
               ...
               [{|
                ...
                {|
                  ...
                  bbody := tApp (tApp <%dispatch%> ([mkLstTm fnTypeTm ["recPredBaseFn"; "recPredIndFn"]])) [tVar "a"; tVar "m"]  
