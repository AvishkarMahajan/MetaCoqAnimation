...
MetaRocq Run (r <- tmEval all (StmN 15 (IntegrateAnimatedTopFnStream (successPoly (Stream) (((from 4)))))) ;; tmPrint r).

MetaRocq Run (r <- tmEval all (StmN 15 (IntegrateAnimatedTopFnStream (successPoly (Stream) (((Seq 4 (Seq 3 (Seq 2 nil)))))))) ;; tmPrint r).
...
Compute (StmN 12 (eqStAnimatedTopFnStream (successPoly (Stream * Stream) ((from 8), (from 9))))).
...
Compute (StmN 50 (filterEvenAnimatedTopFnStream (successPoly (Stream) (from 0)))).

Compute (StmN 25 (filterEvenAnimatedTopFnStream (successPoly (Stream) (Seq 0 (Seq 2 (Seq 3 (Seq 6 (Seq 8 (Seq 10 (Seq 12 nil)))))))))).
