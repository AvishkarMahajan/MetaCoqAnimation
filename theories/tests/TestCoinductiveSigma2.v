...
| plusm : forall m s1 n o s2, addStm m s1 s2 /\ o = m + n -> addStm m (Seq n s1) (Seq (o) s2).
...
Eval cbv -[HoleyResult.hlist_head HoleyResult.hlist_tail IntegrateAn1Symb_unwrap addStmAn2Symb_unwrap] in (IntegrateTransparentSigma2AnimatedTopFn 20 (Success stream (from 4))).
